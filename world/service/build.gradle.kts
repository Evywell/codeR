...
application {
    // property already defined in build script, so we append to the existing list
    applicationDefaultJvmArgs += listOf("-Dworld.grpc.port=12346")
    mainClass = "fr.rob.world.service.Main"
}
