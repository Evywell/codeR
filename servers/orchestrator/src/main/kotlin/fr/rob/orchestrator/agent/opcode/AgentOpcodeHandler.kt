...
open class AgentOpcodeHandler(private val responseStack: ResponseStackInterface, logger: LoggerInterface) :
    OpcodeHandler(logger) {

    override fun initialize() {
        registerOpcode(AUTHENTICATE_SESSION_RESULT, AuthenticationResultOpcode(responseStack))
    }
}
