...
const val CMSG_PLAYER_USE_ABILITY = 0x0B
const val SMSG_ABILITY_STATE_UPDATE = 0x0C
const val SMSG_OBJECT_DESCRIPTION = 0x0D
...
val OPCODES_MAP =
    Array(0x99) { i ->
        when (i) {
            ...
            CMSG_PLAYER_USE_ABILITY -> "CMSG_PLAYER_USE_ABILITY"
            SMSG_ABILITY_STATE_UPDATE -> "SMSG_ABILITY_STATE_UPDATE"
            ...
            SMSG_OBJECT_DESCRIPTION -> "SMSG_OBJECT_DESCRIPTION"
            else -> "UNKNOWN"
        }
    }
